...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'ffmpeg_image_transport.qmax',  'default': '0', 'description': 'Use hardware encoding with ffmpeg transport'},
                           {'name': 'ffmpeg_image_transport.bit_rate','default': '16485760', 'description': 'Use hardware encoding with ffmpeg transport'},
